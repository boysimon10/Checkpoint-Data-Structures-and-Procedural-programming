...
Étape 3 : Boucle externe
Une boucle parcourt les éléments du premier tableau (ensemble1).

Étape 4 : Boucle interne
Une autre boucle parcourt les éléments du deuxième tableau (ensemble2).

Étape 5 : Comparaison des éléments
Comparaison des éléments de chaque tableau.

Étape 6 : Accumulation de la somme
Si un élément est distinct, il est ajouté à la somme.

Étape 7 : Affichage de la somme
Affiche la somme totale des éléments distincts
